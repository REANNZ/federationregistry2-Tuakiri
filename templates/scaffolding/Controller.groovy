<%=packageName ? "package ${packageName}\n\n" : ''%>class ${className}Controller {
    ...
    def save = {
        ...
        if (${propertyName}.save(flush: true)) {
			flash.type="success"
            flash.message = "\${message(code: 'default.created.message', args: [message(code: '${domainClass.propertyName}.label'), ${propertyName}.toString()])}"
        ...
        if (${propertyName}) {
            if (params.version) {
                ...
                if (${propertyName}.version > version) {
                    ...
                    ${propertyName}.errors.rejectValue("version", "default.optimistic.locking.failure", [message(code: '${domainClass.propertyName}.label')])
