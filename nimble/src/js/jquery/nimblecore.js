...
nimble.listLogins = function(userID) {
  ...
  $.ajax({
    ...
    data: dataString,
    success: function(res) {
      $("#loginhistory").empty().append(res).fadeIn();
    },
    error: function (xhr) {
      nimble.growl('error', xhr.responseText);
    }
...
nimble.listPermissions = function(ownerID) {
  ...
  $.ajax({
    ...
    data: dataString,
    success: function(res) {
      $("#currentpermission").empty().append(res).fadeIn();
    },
    error: function (xhr) {
      nimble.growl('error', xhr.responseText);
    }
...
nimble.searchRoles = function(ownerID) {
  ...
  $.ajax({
    ...
    success: function(res) {
      ...
      $("#rolesearchresponse").append(res).fadeIn();
    },
    error: function (xhr) {
      nimble.growl("error", xhr.responseText);
    }
...
nimble.listRoles = function(ownerID) {
  ...
  $.ajax({
    ...
    data: dataString,
    success: function(res) {
      $("#assignedroles").empty().append(res).fadeIn();
    },
    error: function (xhr) {
      nimble.growl('error', xhr.responseText);
    }
...
nimble.searchGroups = function(parentID) {
  ...
  $.ajax({
    ...
    success: function(res) {
      ...
      $("#groupsearchresponse").append(res).fadeIn();
    },
    error: function (xhr) {
      nimble.growl("error", xhr.responseText);
    }
...
nimble.listGroups = function(parentID) {
  ...
  $.ajax({
    ...
    data: dataString,
    success: function(res) {
      $("#assignedgroups").empty().append(res).fadeIn();
    },
    error: function (xhr) {
      nimble.growl('error', xhr.responseText);
    }
...
nimble.searchMembers = function(ownerID) {
  ...
  $.ajax({
    ...
    success: function(res) {
      ...
      $("#membersearchresponse").append(res).fadeIn();
    },
    error: function (xhr) {
      nimble.growl("error", xhr.responseText);
    }
...
nimble.searchGroupMembers = function(ownerID) {
  ...
  $.ajax({
    ...
    success: function(res) {
      ...
      $("#membergroupsearchresponse").append(res).fadeIn();
    },
    error: function (xhr) {
      nimble.growl("error", xhr.responseText);
    }
...
nimble.listMembers = function(ownerID) {
  ...
  $.ajax({
    ...
    success: function(res) {
      ...
      $("#currentmembers").append(res).fadeIn();
    },
    error: function (xhr) {
      nimble.growl("error", xhr.responseText);
    }
