...
<body>
	...
	<p>
  		<a href="${createLink(absolute:true, controller: 'account', action: 'validateuser', id: user.id, params: [activation: user.actionHash])}"><g:message code="label.activateaccount" /></a>
	</p>
