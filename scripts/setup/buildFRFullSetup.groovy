...
frSetup.append("import grails.plugins.nimble.core.*\n")
frSetup.append("import fedreg.host.*\n")
frSetup.append("import fedreg.workflow.*\n")
frSetup.append("import fedreg.core.*\n")
...
frSetup.append("def internalUser = User.findByUsername('internaladministrator')\n\n")
