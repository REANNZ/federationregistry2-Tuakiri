...
class TaskDefinition {
    ...
    List actioners
   	...
   	static hasMany = [instances: TaskInstance, actioners: String, dependencies: String, actionResults: ActionResultDefinition]
    static belongsTo = [parentProcess: ProcessDefinition]
