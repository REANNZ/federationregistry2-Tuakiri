			...
			<div>
				...
				<table class="datatable buttons">
					<tbody>		
						...
						<tr>
							<td colspan="2"><button class="button icon icon_user_go" type="submit"><g:message code="fedreg.link.update" /></button> <g:link action="show" id="${contact.id}" class="button icon icon_cancel"><g:message code="fedreg.link.cancel" /></g:link></td>
					</tbody>
				</table>
