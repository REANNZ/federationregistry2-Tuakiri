  ...
  <body>
    <div class="centered">
      <form id="detailed-dsutilization-report-parameters" class="form-inline report-parameters well validating">
        ...
        <a class="request-detailed-dsutilization-reports btn"><g:message encodeAs="HTML" code="label.generate"/></a>
        <a class="export-detailed-dsutilization-report export-button btn btn-info hidden" rel="tooltip" title="${g.message(encodeAs:"HTML", code:'label.exportexcel')}"><i class="icon-edit icon-white"></i></a>
      </form>
    </div>
