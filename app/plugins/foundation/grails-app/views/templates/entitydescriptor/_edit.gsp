...
<div id="editor-entitydescriptor-migrateorg" class="revealable">
  ...
  <p class="alert alert-info"><g:message code="templates.fr.entitydescriptor.overview.migrateorganization" /></p>
...
<div id="archive-entitydescriptor-modal" class="modal hide fade">
  <div class="modal-header">
    ...
    <h3><g:message code="templates.fr.entitydescriptor.archive.confirm.title"/></h3>
  </div>
  <div class="modal-body">
    <p><g:message code="templates.fr.entitydescriptor.archive.confirm.descriptive"/></p>
  </div>
...
<div id="unarchive-entitydescriptor-modal" class="modal hide fade">
  <div class="modal-header">
    <a class="close close-modal">&times;</a>
    <h3><g:message code="templates.fr.entitydescriptor.unarchive.confirm.title"/></h3>
  </div>
  <div class="modal-body">
    <p><g:message code="templates.fr.entitydescriptor.unarchive.confirm.descriptive"/></p>
  </div>
  <div class="modal-footer">
    <a class="btn close-modal"><g:message code="label.cancel" /></a>
...
<div id="delete-entitydescriptor-modal" class="modal hide fade">
  <div class="modal-header">
    <a class="close close-modal">&times;</a>
    <h3><g:message code="templates.fr.entitydescriptor.delete.confirm.title"/></h3>
  </div>
  <div class="modal-body">
    <p><g:message code="templates.fr.entitydescriptor.delete.confirm.descriptive"/></p>
  </div>
  <div class="modal-footer">
    <a class="btn close-modal"><g:message code="label.cancel" /></a>
