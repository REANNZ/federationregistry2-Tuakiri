    ...
    <tbody>
      <g:each in="${entity.spDescriptors}" var="sp">
        <tr>
          ...
          <td><a href="${createLink(controller:'serviceProvider', action:'show', id:sp.id)}" class="btn btn-small"><g:message code="label.view"/></a></td>
        </tr>
      </g:each>
    </tbody>
  </table>
...
<g:else>
  <p class="alert alert-message"><g:message code="views.fr.foundation.entity.show.no.serviceproviders" /></p>
</g:else>