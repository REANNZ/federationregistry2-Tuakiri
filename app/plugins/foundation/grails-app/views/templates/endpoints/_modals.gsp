<div id="toggle-endpoint-modal" class="modal hide fade">
  ...
  <div class="modal-body">
    <p><g:message code="fedreg.templates.endpoints.toggle.confirm.descriptive"/></p>
  </div>
...
<div id="makedefault-endpoint-modal" class="modal hide fade">
  ...
  <div class="modal-body">
    <p><g:message code="fedreg.templates.endpoints.makedefault.confirm.descriptive"/></p>
  </div>
  <div class="modal-footer">
    <a class="btn close-modal"><g:message code="label.cancel" /></a>
...
<div id="delete-endpoint-modal" class="modal hide fade">
  ...
  <div class="modal-body">
    <p><g:message code="fedreg.templates.endpoints.remove.confirm.descriptive"/></p>
  </div>
  <div class="modal-footer">
    <a class="btn close-modal"><g:message code="label.cancel" /></a>
