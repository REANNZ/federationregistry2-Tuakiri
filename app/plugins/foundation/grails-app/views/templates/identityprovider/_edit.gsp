  ...
  <g:form action="update" id="${identityProvider.id}" method="PUT" class="form-horizontal validating">
    ...
    <fieldset>
      <div class="control-group">
        <label class="control-label" for="idp.status"><g:message code="label.status" /></label>
        <div class="controls">
      ...
      <div class="control-group">
        <label class="control-label" for="idp.autoAcceptServices"><g:message code="label.usesaa" /></label>
        <div class="controls">
      ...
      <div class="control-group">
        <label class="control-label" for="idp.scope"><g:message code="label.scope" /></label>
        <div class="controls">
