<html>
  ...
  <body>
    <h2><g:message code="views.fr.foundation.contacts.create.heading" /></h2>
    ...
    <g:form action="save" class="form validating">
      ...
      <div class="form-actions">
        <button type="submit" class="btn btn-success"><g:message code="label.save" default="Save"/></button>
        <g:link action="list" class="btn"><g:message code="label.cancel" default="Cancel"/></g:link>
      </div>
