					...
					<tbody>	
						...
						<tr>
							<tr>
								...
								<td><input type="text" name="email" value="${fieldValue(bean: contact, field: 'email')}" /></td>
							</tr>
						</tr>
						<tr>
							<th><g:message code="label.secondaryemail" /></th>
							<td>
								<input type="text" name="secondaryEmail" value="${fieldValue(bean: contact, field: 'secondaryEmail')}" />
							</td>
						</tr>
						<tr>
