...
class OrganizationContactController {
	...
	def create = {
		...
		if(SecurityUtils.subject.isPermitted("federation:management:organization:${organization.id}:contact:add") || SecurityUtils.subject.isPermitted("federation:management:contacts")) {
	...
	def delete = {
		...
		if(SecurityUtils.subject.isPermitted("federation:management:organization:${organization.id}:contact:remove") || SecurityUtils.subject.isPermitted("federation:management:contacts")) {
