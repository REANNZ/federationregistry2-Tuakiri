    ...
    <div id="show-organizationType" class="content scaffold-show" role="main">
      ...
      <ul class="property-list organizationType clean">
        ...
        <li class="fieldcontain">
          <strong><span id="id-label" class="property-label"><g:message code="organizationType.id.label" default="Id" /></span></strong>: 
        ...
        <li class="fieldcontain">
          <strong><span id="name-label" class="property-label"><g:message code="organizationType.name.label" default="Name" /></span></strong>: 
        ...
        <li class="fieldcontain">
          <strong><span id="displayName-label" class="property-label"><g:message code="organizationType.displayName.label" default="Display Name" /></span></strong>: 
        ...
        <li class="fieldcontain">
          <strong><span id="description-label" class="property-label"><g:message code="organizationType.description.label" default="Description" /></span></strong>: 
        ...
        <li class="fieldcontain">
          <strong><span id="discoveryServiceCategory-label" class="property-label"><g:message code="organizationType.discoveryServiceCategory.label" default="Discovery Service Category" /></span></strong>: 
        ...
        <li class="fieldcontain">
          <strong><span id="dateCreated-label" class="property-label"><g:message code="organizationType.dateCreated.label" default="Date Created" /></span></strong>: 
        ...
        <li class="fieldcontain">
          <strong><span id="lastUpdated-label" class="property-label"><g:message code="organizationType.lastUpdated.label" default="Last Updated" /></span></strong>: 
      ...
      <g:form>
        <fieldset class="buttons">
          ...
          <g:link class="edit" action="edit" id="${organizationTypeInstance?.id}" class="btn btn-info"><g:message code="default.button.edit.label" default="Edit" /></g:link>
