...
<div class="fieldcontain ${hasErrors(bean: CAKeyInfoInstance, field: 'certificate', 'error')} ">
  <label for="certificate">
    <g:message encodeAs="HTML" code="CAKeyInfo.certificate.label" default="Certificate" />  
  </label>
...
<div class="fieldcontain ${hasErrors(bean: CAKeyInfoInstance, field: 'expiryDate', 'error')} ">
  <label for="expiryDate">
    <g:message encodeAs="HTML" code="CAKeyInfo.expiryDate.label" default="Expiry Date" />
  </label>
...
<div class="fieldcontain ${hasErrors(bean: CAKeyInfoInstance, field: 'keyName', 'error')} ">
  <label for="keyName">
    <g:message encodeAs="HTML" code="CAKeyInfo.keyName.label" default="Key Name" />
  </label>
