...
<div class="fieldcontain ${hasErrors(bean: attributeBaseInstance, field: 'name', 'error')} ">
  <label for="name">
    <g:message encodeAs="HTML" code="attributeBase.name.label" default="Name" />
...
<div class="fieldcontain ${hasErrors(bean: attributeBaseInstance, field: 'legacyName', 'error')} ">
  <label for="legacyName">
    <g:message encodeAs="HTML" code="attributeBase.legacyName.label" default="Legacy Name" />
...
<div class="fieldcontain ${hasErrors(bean: attributeBaseInstance, field: 'oid', 'error')} ">
  <label for="oid">
    <g:message encodeAs="HTML" code="attributeBase.oid.label" default="oid" />
...
<div class="fieldcontain ${hasErrors(bean: attributeBaseInstance, field: 'description', 'error')} ">
  <label for="description">
    <g:message encodeAs="HTML" code="attributeBase.description.label" default="Description" />
...
<div class="fieldcontain ${hasErrors(bean: attributeBaseInstance, field: 'nameFormat', 'error')} ">
  <label for="nameFormat">
    <g:message encodeAs="HTML" code="attributeBase.nameFormat.label" default="Name Format" />

  </label>
  <g:select id="nameFormat" name="nameFormat.id" from="${aaf.fr.foundation.SamlURI.findAllWhere(type:aaf.fr.foundation.SamlURIType.AttributeNameFormat)}" optionKey="id" optionValue="${{it.uri?.encodeAsHTML()}}" required="" value="${attributeBaseInstance?.nameFormat?.id}" class="many-to-one span4"/>
</div>


<div class="fieldcontain ${hasErrors(bean: attributeBaseInstance, field: 'category', 'error')} ">
  <label for="category">
    <g:message encodeAs="HTML" code="attributeBase.category.label" default="Category" />

  </label>
  <g:select id="category" name="category.id" from="${aaf.fr.foundation.AttributeCategory.list()}" optionKey="id" optionValue="${{it.name?.encodeAsHTML()}}" required="" value="${attributeBaseInstance?.category?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: attributeBaseInstance, field: 'specificationRequired', 'error')} ">
  <label for="specificationRequired">
    <g:message encodeAs="HTML" code="attributeBase.specificationRequired.label" default="Specification Required" />
...
<div class="fieldcontain ${hasErrors(bean: attributeBaseInstance, field: 'adminRestricted', 'error')} ">
  <label for="adminRestricted">
    <g:message encodeAs="HTML" code="attributeBase.adminRestricted.label" default="Admin Restricted" />
