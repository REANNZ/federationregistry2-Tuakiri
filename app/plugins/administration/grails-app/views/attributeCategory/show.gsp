    ...
    <div id="show-attributeCategory" class="content scaffold-show" role="main">
      ...
      <ul class="property-list attributeCategory clean">
        ...
        <li class="fieldcontain">
          <strong><span id="id-label" class="property-label"><g:message encodeAs="HTML" code="attributeCategory.id.label" default="id" /></span></strong>: 
        ...
        <li class="fieldcontain">
          <strong><span id="name-label" class="property-label"><g:message encodeAs="HTML" code="attributeCategory.name.label" default="Name" /></span></strong>: 
        ...
        <li class="fieldcontain">
          <strong><span id="dateCreated-label" class="property-label"><g:message encodeAs="HTML" code="attributeCategory.dateCreated.label" default="Date Created" /></span></strong>: 
        ...
        <li class="fieldcontain">
          <strong><span id="lastUpdated-label" class="property-label"><g:message encodeAs="HTML" code="attributeCategory.lastUpdated.label" default="Last Updated" /></span></strong>: 
      ...
      <g:form>
        <fieldset class="buttons">
          ...
          <g:link class="edit" action="edit" id="${attributeCategoryInstance?.id}" class="btn btn-info"><g:message encodeAs="HTML" code="label.edit" default="Edit" /></g:link>
