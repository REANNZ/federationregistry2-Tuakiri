    ...
    <div id="show-contactType" class="content scaffold-show" role="main">
      ...
      <ul class="property-list contactType clean">
        ...
        <li class="fieldcontain">
          <strong><span id="id-label" class="property-label"><g:message encodeAs="HTML" code="contactType.id.label" default="id" /></span></strong>: 
        ...
        <li class="fieldcontain">
          <strong><span id="name-label" class="property-label"><g:message encodeAs="HTML" code="contactType.name.label" default="Name" /></span></strong>: 
        ...
        <li class="fieldcontain">
          <strong><span id="displayName-label" class="property-label"><g:message encodeAs="HTML" code="contactType.displayName.label" default="Display Name" /></span></strong>: 
        ...
        <li class="fieldcontain">
          <strong><span id="description-label" class="property-label"><g:message encodeAs="HTML" code="contactType.description.label" default="Description" /></span></strong>: 
        ...
        <li class="fieldcontain">
          <strong><span id="dateCreated-label" class="property-label"><g:message encodeAs="HTML" code="contactType.dateCreated.label" default="Date Created" /></span></strong>: 
        ...
        <li class="fieldcontain">
          <strong><span id="lastUpdated-label" class="property-label"><g:message encodeAs="HTML" code="contactType.lastUpdated.label" default="Last Updated" /></span></strong>: 
      ...
      <g:form>
        <fieldset class="buttons">
          ...
          <g:link class="edit" action="edit" id="${contactTypeInstance?.id}" class="btn btn-info"><g:message encodeAs="HTML" code="label.edit" default="Edit" /></g:link>
