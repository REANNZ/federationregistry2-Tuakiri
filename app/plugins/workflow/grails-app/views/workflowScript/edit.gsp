...
<html>
  ...
  <body>
      <h2><g:message code="views.fr.workflow.script.edit.heading" args="[script.name]"/></h2>
      ...
      <g:form action="update" id="${script.id}">      
        ...
        <br>
        <button type="submit" class="btn"/><g:message code="label.update" /></button>
        <g:link class="btn" controller="workflowScript" action="show" id="${script.id}"><g:message code="label.cancel" default="Cancel"/></g:link>
      </g:form>
