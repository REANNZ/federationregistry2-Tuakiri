...
class WorkflowTaskServiceSpec extends IntegrationSpec {
    ...
    processInstance.taskInstances.get(0).potentialApprovers.size() == 1
		...
		message.subject == 'templates.fr.mail.workflow.requestapproval.subject'
	}
    ...
    processInstance.taskInstances.get(0).potentialApprovers.size() == 2
		...
		def message = greenMail.getReceivedMessages()[0]
		'templates.fr.mail.workflow.requestapproval.subject' == message.subject
		...
		'templates.fr.mail.workflow.requestapproval.subject' == message2.subject
