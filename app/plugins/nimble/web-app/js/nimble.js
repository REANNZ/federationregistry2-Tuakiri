...
nimble.searchGroups = function(parentID) {
  ...
  $.ajax({
	...
	data: dataString,
	success: function(res) {
		var target = $("#groupsearchresponse");
		target.html(res);
		applyBehaviourTo(target);
	},
	error: function (xhr) {
...
nimble.searchMembers = function(ownerID) {
  ...
  $.ajax({
	...
	data: dataString,
	success: function(res) {
		var target = $("#membersearchresponse");
		target.html(res);
		applyBehaviourTo(target);
	},
	error: function (xhr) {
...
nimble.searchGroupMembers = function(ownerID) {
  ...
  $.ajax({
	...
	data: dataString,
	success: function(res) {
		var target = $("#membergroupsearchresponse");
		target.html(res);
		applyBehaviourTo(target);
