...
<body>
	...
	<p>
  		<a href="${createLink(absolute:true, controller: 'profile', action: 'validateemail', id: user.id, params: [activation: user.actionHash])}"><g:message code="label.verifyemail" /></a>
	</p>
