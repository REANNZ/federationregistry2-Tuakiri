...
class LevelPermission extends Permission {
    ...
    public populate(first, second, third, fourth, fifth, sixth) {
        ...
        if (first == null || first == '' || first.contains(this.levelSep)) {
            this.errors.rejectValue('target', 'aaf.fr.identity.levelpermission.invalid.first.sector')
            return
        }
        ...
        if (second) {
            if (second.contains(this.levelSep)) {
                this.errors.rejectValue('target', 'aaf.fr.identity.levelpermission.invalid.second.sector')
                return
            }
            ...
            if (third) {
                if (third.contains(this.levelSep)) {
                    this.errors.rejectValue('target', 'aaf.fr.identity.levelpermission.invalid.third.sector')
                    return
                }
                ...
                if (fourth) {
                    if (fourth.contains(this.levelSep)) {
                        this.errors.rejectValue('target', 'aaf.fr.identity.levelpermission.invalid.fourth.sector')
                        return
                    }
                    ...
                    if (fifth) {
                        if (fifth.contains(this.levelSep)) {
                            this.errors.rejectValue('target', 'aaf.fr.identity.levelpermission.invalid.fifth.sector')
                            return
                        }
                        ...
                        if (sixth) {
                            if (sixth.contains(this.levelSep)) {
                                this.errors.rejectValue('target', 'aaf.fr.identity.levelpermission.invalid.sixth.sector')
                                return
                            }
