...
<html>
  ...
  <body>
      <h2><g:message encodeAs="HTML" code="views.fr.workflow.script.list.heading" /></h2>
      ...
      <table class="table table-sortable borderless">
        ...
        <g:each in="${scriptList}" var="p" status="i">
          <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
            ...
            <td>
              <a href="${createLink(controller:'workflowScript', action:'show', id: p.id)}" class="btn"><g:message encodeAs="HTML" code="label.view" default="View"/></a>
            </td>
          </tr>
        </g:each>
        </tbody>
