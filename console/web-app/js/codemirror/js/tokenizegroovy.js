...
var tokenizeGroovy = (function() {
  ...
  var keywords = function(){
    ...
    return {
      ...
      "println": result("println", "groovy-keyword"),
      "print": result("print", "groovy-keyword"),
      "synchronized": operator,
      "final": keywordC, "private": keywordC, "default": keywordC, "transient": keywordC, "static": keywordC,
      "each": result("each", "groovy-keyword"),
      "collect": result("collect", "groovy-keyword"),  
      "constraints": result("constraints", "grails-keyword"),
      "mapping": result("constraints", "grails-keyword"),
      "def": result("def", "groovy-keyword"), "catch": result("catch", "groovy-keyword"),
