                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: identityProviderInstance, field: 'organization', 'errors')}">
                                    <g:select name="organization.id" from="${aaf.fedreg.saml2.metadata.orm.Organization.list()}" optionKey="id" value="${identityProviderInstance?.organization?.id}" noSelection="['null': '']" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: identityProviderInstance, field: 'errorURL', 'errors')}">
                                    <g:select name="errorURL.id" from="${aaf.fedreg.saml2.metadata.orm.UrlURI.list()}" optionKey="id" value="${identityProviderInstance?.errorURL?.id}" noSelection="['null': '']" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: identityProviderInstance, field: 'protocolSupportEnumerations', 'errors')}">
                                    <g:select name="protocolSupportEnumerations" from="${aaf.fedreg.saml2.metadata.orm.SamlURI.list()}" multiple="yes" optionKey="id" size="5" value="${identityProviderInstance?.protocolSupportEnumerations}" />
                                </td>
                            </tr>
...
<g:link controller="keyDescriptor" action="create" params="['identityProvider.id': identityProviderInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'keyDescriptor.label', default: 'KeyDescriptor')])}</g:link>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: identityProviderInstance, field: 'nameIDFormats', 'errors')}">
                                    <g:select name="nameIDFormats" from="${aaf.fedreg.saml2.metadata.orm.SamlURI.list()}" multiple="yes" optionKey="id" size="5" value="${identityProviderInstance?.nameIDFormats}" />
                                </td>
                            </tr>
...
<g:link controller="assertionIDRequestService" action="create" params="['identityProvider.id': identityProviderInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'assertionIDRequestService.label', default: 'AssertionIDRequestService')])}</g:link>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: identityProviderInstance, field: 'attributeProfiles', 'errors')}">
                                    <g:select name="attributeProfiles" from="${aaf.fedreg.saml2.metadata.orm.SamlURI.list()}" multiple="yes" optionKey="id" size="5" value="${identityProviderInstance?.attributeProfiles}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: identityProviderInstance, field: 'attributes', 'errors')}">
                                    <g:select name="attributes" from="${aaf.fedreg.saml2.metadata.orm.Attribute.list()}" multiple="yes" optionKey="id" size="5" value="${identityProviderInstance?.attributes}" />
                                </td>
                            </tr>
