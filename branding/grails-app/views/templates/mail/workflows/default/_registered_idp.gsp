...
<g:applyLayout name="email">
  <html>
    <head></head>
    <body>
      This email confirms that the Identity Provider which you've registered with the Australian Access Federation has been <strong>received but is not yet ready for use</strong>. 
      <br/><br/>
