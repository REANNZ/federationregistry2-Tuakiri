<ul class="level1">
  <fr:isNotLoggedIn>
    <li class="${controllerName == 'auth' ? 'directactive':''}">
      <g:link controller="auth"><g:message code="fr.branding.nav.login" default="Login"/></g:link>
    </li>
    <li class="${controllerName == 'bootstrap' && ['organization', 'saveorganization','organizationregistered'].contains(actionName) ? 'directactive':''}">
      <g:link controller="bootstrap" action="organization"><g:message code="fr.branding.nav.regorg" default="Create Organisation"/></g:link>
    </li>
    <li class="${controllerName == 'bootstrap' && ['idp', 'saveidp','idpregistered'].contains(actionName) ? 'directactive':''}">
      <g:link controller="bootstrap" action="idp"><g:message code="fr.branding.nav.regidp" default="Create Identity Provider" /></g:link>
    </li>
    <li class="${controllerName == 'bootstrap' && ['sp', 'savesp','spregistered'].contains(actionName) ? 'directactive':''}">
      <g:link controller="bootstrap" action="sp"><g:message code="fr.branding.nav.regsp" default="Create Service Provider" /></g:link>
    </li>
  </fr:isNotLoggedIn>
  <fr:isLoggedIn>
    ...
    <li class="${['organization', 'entityDescriptor', 'identityProvider', 'serviceProvider', 'contacts'].contains(controllerName) ? 'active' : ''}">
      <g:link controller="organization" action="list"><g:message code="fr.branding.nav.subscribers" default="Subscribers" /></g:link>
    </li>
    <li class="${['federationReports', 'identityProviderReports', 'serviceProviderReports', 'complianceReports'].contains(controllerName) ? 'active' : ''}">
      <fr:hasPermission target="federation:management:reporting">
        <g:link controller="federationReports" action="summary"><g:message code="fr.branding.nav.reporting" default="Reporting" /></g:link>
      </fr:hasPermission>
    ...
    <fr:isAdministrator>
      <li class="${request.forwardURI.contains("administration") ? 'active' : ''}">
        <g:link controller="adminDashboard"><g:message code="fr.branding.nav.administration" default="Administration" /></g:link>
      </li>
    </fr:isAdministrator>
  </fr:isLoggedIn>
  <li><a style="color: #fff;" href="/federationstatus" target="_blank"><g:message code="fr.branding.nav.monitoring" default="Federation Status" /></a></li>
  ...
  <fr:isLoggedIn>
    <li>
      <g:link controller="auth" action="logout"><g:message code="fr.branding.nav.logout" default="Logout" /></g:link>
    </li>
  </fr:isLoggedIn>
</ul>
