...
<html>
	...
	<body style="padding:0; margin:0; font-family: Helvetica, Arial, sans-serif; font-size: 1.0em;">
		<div style="padding: 6px; height: 70px; background-color: #495666; color: #ffffff">
			<img style="float:left; padding-right: 6px;" src="${resource(absolute: true, dir:'images', file:'logo.jpg', plugin:'federationregistry')}" alt="${message(code:'fedreg.title')}" border="0" />
